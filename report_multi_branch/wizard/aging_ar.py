...
class AgingARWizard(models.TransientModel):
    _name = 'aging.ar.wizard'
    ...
    def action_view(self):
        ...
        return self.env.ref('report_multi_branch.action_report_aging_ar').report_action(self, data=data)
        
    
    def action_xls(self):
        return {
            'type': 'ir.actions.act_url',
            'url': '/aging_ar/export/%s' % (self.id),
            'target': 'new',
        }