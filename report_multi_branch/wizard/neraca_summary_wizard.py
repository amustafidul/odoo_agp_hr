...
class NeracaSummaryWizard(models.Model):
    _name = "neraca.summary.mb.wizard"
    ...
    def action_view(self):
        ...
        return self.env.ref('report_multi_branch.action_report_neraca_summary').report_action(self, data=data)

    def check_report_neraca(self):
        return {
            'type': 'ir.actions.act_url',
            'url': '/neraca_summary/export/%s' % (self.id),
            'target': 'new',
        }
    ...
    # # def view_tree(self):
    # #     return {
    # #         'name': 'Financial Tree View',
    # #         'view_mode': 'tree',
    # #         'res_model': 'financial.data',
    # #         'view_type': 'tree',
