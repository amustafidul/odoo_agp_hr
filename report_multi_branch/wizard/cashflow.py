...
class CashflowWizard(models.Model):
    _name = "cashflow.mb.wizard"
    _description = "Cashflow Wizard"
    ...
    def action_view(self):
        ...
        return self.env.ref('report_multi_branch.action_report_cashflow').report_action(self, data=data)

    
    def check_report_cashflow(self):
        return {
            'type': 'ir.actions.act_url',
            'url': '/cashflow/export/%s' % (self.id),
            'target': 'new',
        }
