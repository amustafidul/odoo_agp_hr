...
class PenagihanWizard(models.TransientModel):
    _name = 'account.keuangan.penagihan.wizard'
    ...
    # Related tree fields
    payment_line_ids = fields.One2many('account.keuangan.penagihan.line', 'payment_wizard_id', string="Detail Pembayaran")
...
class PenagihanLine(models.TransientModel):
    _name = 'account.keuangan.penagihan.line'
    _description = 'Detail Penagihan'

    payment_wizard_id = fields.Many2one('account.payment.register.wizard', string="Wizard Pembayaran")
