...
_logger = logging.getLogger('base.partner.merge.automatic.wizard')
...
class BasePartnerMergeAutomaticWizard(models.TransientModel):
    ...
    def _merge(self, partner_ids, dst_partner=None):
        ...
        """
        if self.env.user.has_group('base.group_system') or self.env.user.has_group('agp_custom_fields.group_advisor'):
            extra_checks = False
